...
// Re-pointed (M9) at the sino demo inscription shipped with the data package.
describe('TEI-Publisher Metadata Panel', () => {
  ...
  describe('Metadata Content', () => {
    it('displays document metadata when available', () => {
      ...
      cy.contains('測試造像記', { timeout: 10000 }).should('be.visible')
    ...
    it('shows teiHeader information', () => {
      ...
      cy.get('body').then(($body) => {
        ...
        const hasHeaderInfo = text.includes('測試造像記') || // Title from demo doc
