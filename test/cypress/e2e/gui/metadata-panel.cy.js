...
// TODO(M7): re-enable against a sino demo inscription. The generated suite
// visits the TEI Publisher demo document (demo/kant_rvernunft_1781.TEI-P5.xml,
// dta.odd), which EDEp does not ship, so the before-each hook can never pass.
describe.skip('TEI-Publisher Metadata Panel', () => {
  beforeEach(() => {
